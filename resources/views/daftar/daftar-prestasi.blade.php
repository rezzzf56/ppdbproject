            ...
            <div class="card-body mt-2">
                <form action="{{route('form.storereg')}}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="col-sm-11">   
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-1 col-form-label text-sm-start" data-capitalize="words" for="nama_lengkap">Nama</label>
                        <div class="col-sm-11">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-1 col-form-label text-sm-start" for="prestasi">Prestasi</label>
                        <div class="col-sm-11">
                              <input type="file" name="prestasi" id="prestasi" class="form-control" data-capitalize="words" accept="image/*" />
